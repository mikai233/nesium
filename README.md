...
| Suite name                  | ROM path / directory                                    | Notes                                        | TASVideos accuracy‑required |
| --------------------------- | ------------------------------------------------------- | -------------------------------------------- | --------------------------- |
| `_240pee_suite`             | `240pee/240pee-bnrom.nes`, `240pee/240pee.nes`          | TV colour diversity / timing test            | No                          |
| `mmc1_a12_suite`            | `MMC1_A12/mmc1_a12.nes`                                 | MMC1 A12 line behaviour                      | No                          |
...
| `cpu_dummy_reads_suite`     | `cpu_dummy_reads/cpu_dummy_reads.nes`                   | CPU dummy read behaviour                     | Yes                         |
| `cpu_dummy_writes_suite`    | `cpu_dummy_writes/*.nes`                                | CPU dummy write behaviour                    | Yes                         |
| `cpu_timing_test6_suite`    | `cpu_timing_test6/cpu_timing_test.nes`                  | TASVideos CPU timing (TV SHA1)               | Yes                         |
...
| `ny2011_suite`              | `ny2011/ny2011.nes`                                     | Visual diversity / timing                    | No                          |
| `oam_read_suite`            | `oam_read/oam_read.nes`                                 | OAM read behaviour                           | Yes                         |
| `oam_stress_suite`          | `oam_stress/oam_stress.nes`                             | OAM stress / overflow conditions             | Yes                         |
| `spritecans_2011_suite`     | `spritecans-2011/spritecans.nes`                        | Visual diversity / sprite stress             | No                          |
| `stomper_suite`             | `stomper/smwstomp.nes`                                  | Visual diversity / timing                    | No                          |
| `tutor_suite`               | `tutor/tutor.nes`                                       | Visual diversity / reference demo            | No                          |
| `window5_suite`             | `window5/colorwin_ntsc.nes`, `window5/colorwin_pal.nes` | Colour windowing tests (NTSC/PAL)            | No                          |
...
| Suite name             | ROM path / directory         | Notes                                                                               | TASVideos accuracy‑required |
| ---------------------- | ---------------------------- | ----------------------------------------------------------------------------------- | --------------------------- |
| `paddletest3_manual`   | `PaddleTest3/PaddleTest.nes` | Paddle/analog controller test; follow ROM `Info.txt` for instructions               | No                          |
| `tvpassfail_manual`    | `tvpassfail/tv.nes`          | TV characteristics (NTSC chroma/luma, artifacts); verify visually                   | No                          |
| `vaus_test_manual`     | `vaus-test/vaus-test.nes`    | Arkanoid Vaus controller test (interactive)                                         | No                          |
