...
pub enum TextId {
    ...
    InputRecordingSection,
    InputRecordingStatusLabel,
    InputRecordingStatusIdle,
    InputRecordingStatusRecording,
    InputRecordingOutputLabel,
    InputRecordingEventsLabel,
    InputRecordingStart,
    InputRecordingStopAndSave,
    InputRecordingLastSavedLabel,
    InputRecordingLastErrorLabel,
    InputRecordingHelp,
    InputDeviceKeyboard,
    InputDeviceDisabled,
    InputNoGamepads,
    ...
    InputButtonTurboB,
    InputTurboSection,
    InputTurboOnFramesLabel,
    InputTurboOffFramesLabel,
    InputTurboLinkPressRelease,
    InputTurboHelp,
