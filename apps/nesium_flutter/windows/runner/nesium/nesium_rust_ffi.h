...
using NesiumFrameReadyCallback =
    void(NESIUM_CALLCONV *)(uint32_t /*bufferIndex*/, uint32_t /*width*/,
                            uint32_t /*height*/, uint32_t /*pitch*/,
                            void * /*user*/);

extern "C" {
NESIUM_RUST_IMPORT void nesium_runtime_start();
NESIUM_RUST_IMPORT void nesium_set_frame_ready_callback(
    NesiumFrameReadyCallback cb, void *user);
