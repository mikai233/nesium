...
use self::mapper::{
    ...
    Mapper66, Mapper71, Mapper78, Mapper85, Mapper90, Mapper119, NametableTarget,
};
...
pub fn load_cartridge(bytes: &[u8]) -> Result<Cartridge, Error> {
    ...
    let mut mapper: Box<dyn Mapper> = match header.mapper {
        ...
        66 => Box::new(Mapper66::with_trainer(header, prg_rom, chr_rom, trainer)),
        71 => Box::new(Mapper71::with_trainer(header, prg_rom, chr_rom, trainer)),
        78 => Box::new(Mapper78::with_trainer(header, prg_rom, chr_rom, trainer)),
        85 => Box::new(Mapper85::with_trainer(header, prg_rom, chr_rom, trainer)),
