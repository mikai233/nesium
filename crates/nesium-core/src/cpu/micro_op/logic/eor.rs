...
pub const fn eor_immediate() -> Instruction {
    ...
    const OP2: MicroOp = MicroOp::eor(ReadFrom::Immediate);
    Instruction {
        opcode: Mnemonic::EOR,
...
pub const fn eor_zero_page() -> Instruction {
    ...
    const OP3: MicroOp = MicroOp::eor(ReadFrom::ZeroPage);
    Instruction {
        opcode: Mnemonic::EOR,
...
pub const fn eor_zero_page_x() -> Instruction {
    ...
    const OP4: MicroOp = MicroOp::eor(ReadFrom::Effective);
    Instruction {
        opcode: Mnemonic::EOR,
...
pub const fn eor_absolute_x() -> Instruction {
    ...
    const OP5: MicroOp = MicroOp::eor(ReadFrom::Effective);
    Instruction {
        opcode: Mnemonic::EOR,
...
pub const fn eor_indirect_x() -> Instruction {
    ...
    const OP6: MicroOp = MicroOp::eor(ReadFrom::Effective);
    Instruction {
        opcode: Mnemonic::EOR,
