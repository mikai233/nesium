        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>(crate::api::events::aux_texture_ids().await)?;
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::gamepad::GamepadActionsFfi::default())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok =
                        Ok::<_, ()>(crate::api::gamepad::GamepadPollResultFfi::default())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__net_utils__get_local_addrs_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::net_utils::get_local_addrs())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__net_utils__get_public_ip_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::net_utils::get_public_ip())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__load_rom__get_rom_hash_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::load_rom::get_rom_hash())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__pause__is_paused_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::pause::is_paused())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__video__lcd_grid_options_default_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::video::LcdGridOptions::default())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok =
                            Ok::<_, ()>(crate::api::netplay::netplay_is_connected().await)?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__server__netserver_get_port_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::server::netserver_get_port())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__server__netserver_is_running_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::server::netserver_is_running())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__video__ntsc_bisqwit_options_default_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::video::NtscBisqwitOptions::default())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__video__ntsc_options_default_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::video::NtscOptions::default())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__palette__palette_presets_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::palette::palette_presets())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__video__scanline_options_default_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::video::ScanlineOptions::default())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__pause__toggle_pause_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::pause::toggle_pause())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
impl SseDecode for crate::api::palette::PaletteKind {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        return match inner {
            ...
            4 => crate::api::palette::PaletteKind::Mesen2C02,
            5 => crate::api::palette::PaletteKind::RawLinear,
...
impl flutter_rust_bridge::IntoDart for crate::api::palette::PaletteKind {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            ...
            Self::Mesen2C02 => 4.into_dart(),
            Self::RawLinear => 5.into_dart(),
            _ => unreachable!(),
        }
    }
}
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(
            match self {
                ...
                crate::api::palette::PaletteKind::Mesen2C02 => 4,
                crate::api::palette::PaletteKind::RawLinear => 5,
                _ => {
                    unimplemented!("");
                }
            },
